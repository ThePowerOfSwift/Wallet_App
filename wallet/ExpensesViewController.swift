...
class ExpensesViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITextFieldDelegate {
    ...
    var my_id: Int = Int()
    var expensesSource = ["Rent Paid", "Telephone Bill", "Fare", "Electricity Bill", "Food"]
    @IBOutlet weak var menuBtn: UIBarButtonItem!
    //Set delegate of cashtextfield
    let expensesAmount = Expenses_Delegate()
    override func viewDidLoad() {
        super.viewDidLoad()
        self.amountTxt.delegate = self.expensesAmount
    ...
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return expensesSource.count
    }
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        categoryTxt.text = expensesSource[row]
        self.view.endEditing(false)
    }
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return expensesSource[row]
    }
